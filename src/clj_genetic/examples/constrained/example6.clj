(ns clj-genetic.examples.constrained.example6
...
; 9 constraints
; Selection: binary tournament without replacement with niching
...
(defn -main [& args]
  (prn (run
         ...
         (partial selection/binary-tournament-without-replacement-with-niching limits)
